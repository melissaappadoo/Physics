...
public:
    ...
    XMFLOAT3    v;     // vector part: v.x, v.y, v.z

    Quaternion(void);
    Quaternion(float e0, float e1, float e2, float e3);

    float      Magnitude(void);
    XMFLOAT3    GetVector(void);
...
inline XMFLOAT3 Quaternion::GetVector(void)
{
...
inline Quaternion operator*(Quaternion q, XMFLOAT3 v)
{
...
inline Quaternion operator*(XMFLOAT3 v, Quaternion q)
{
    return Quaternion(-(q.v.x * v.x + q.v.y * v.y + q.v.z * v.z),
...
/*inline XMFLOAT3 QGetAxis(Quaternion q)
{
    XMFLOAT3 v;
    float m;
...
inline XMFLOAT3 QVRotate(Quaternion q, XMFLOAT3 v)
{
    Quaternion t;
    t = q * v * (~q);
    return t.GetVector();
...
inline XMFLOAT3 MakeEulerAnglesFromQ(Quaternion q)
{
